...
<body>
    ...
    <div class="text-center">
        ...
        <p>Thank You For Purchasing With {{ $appSetting->website_name ?? 'E-shop E-Com' }} </p>
        <p>Your Items Will be Shipped To Us Very Soon</p>
    </div>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with E-shop E-Commerce
    </p>
