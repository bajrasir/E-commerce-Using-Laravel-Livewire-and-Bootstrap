                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <div class="product-path">
                            <p> Home / {{ $product->category->name }} / {{ $product->name }}
                        </div>
                        <hr>
                            ...
                            @if ($product->productColors->count() > 0)
                                @if ($product->productColors)
                                    ...
                                    @foreach ($product->productColors as $colorItem)
                                        ...
                                        <label class="colorSelectionLabel" for=""
                                ...
                                <div>
                                    ...
                                    @if ($this->productColorSelectedQuantity == 'outOfStock')
                                        <label class="btn btn-sm py-1 mt-2 text-white bg-danger">Out of
                                            Stock</label>
...
<div class="py-3 py-md-5" style="background-color:#D3D3D3">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-3">
                <h3>Related
